...
def write_to_csv(optional_arg1=(), optional_arg2=(), optional_arg3=()):
    ...
    with open('eda/output_maty.csv', mode='a', newline='') as file:
...
def main():
    global img, ultra_destroy, cisilko, list_of_cisilko
    ultra_destroy = 0
    global first_point, second_point
    first_point = (0,0)
    second_point = (0,0)
    ...
    for p in range (15,22):
        ...
        for i in range(1,5):
            ...
            image_path = r'C:\Users\kiv\Downloads\AstroX\runs\15\meta_ai\metacorrected_'+image_name+'.jpg.bmp'
            image_path_for_sun = r'C:\Users\kiv\Downloads\AstroX\main_original\img_'+str(p)+'.jpg'
            global altitude
            ...
            global getting_cisilko, variable_validation, variable_getting_pixels
            getting_cisilko = True
