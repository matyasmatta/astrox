        ...
        try:
            ...
            def calculate_using_min_max(list_of_values):
                def main():
                    ...
                    print("jsem list of values a bojim se", list_of_values)
                    shadow_low = min(list_of_values)
                    print("min max shadow low", shadow_low)
                    cloud_high = max(list_of_values)
                    print("min max cloud_high", cloud_high)
            ...
            print("shadow_lenght_min_max", calculate_using_min_max(list_of_values))
            shadow_lenght_max_difference = calculate_using_maximum_change(list_of_values)
            print("shadow_lenght_max_difference", calculate_using_maximum_change(list_of_values))
            shadow_lenght_max_difference_red = calculate_using_maximum_change(list_of_red)
            print("shadow_lenght_max_difference_red", calculate_using_maximum_change(list_of_red))
            shadow_lenght_final = (shadow_lenght_max_difference+shadow_lenght_min_max+shadow_lenght_max_difference_red)/3
            print("shadow_lenght_final", shadow_lenght_final)
