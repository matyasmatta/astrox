...
try:
    ...
    # initialization
    try:
        while (datetime.datetime.now() < start_time + timedelta(seconds=10)):
            photo.get_photo(camera)
    ...
    try:
        ...
        imageName = str("./sample_crop/obrazek (" + str(initialization_count) + ").jpg")
        ...
        while (datetime.datetime.now() < start_time + timedelta(minutes=3)):
