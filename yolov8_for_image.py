...
def get_results(result, path, name):
    ...
    try:
        for obj in xyxy:
            ...
            def check(a):
                if a == "x":
                    ...
                    centre_var = "ycentre"
                check = []
                for counter in range(limiter):
                    check.append(centre[a]+counter-(limiter/2))
                resemble = False
            ...
            if bbox['accuracy'] > accuracy and resemble_x == False and resemble_y == False and width < 100:
        ...
        pass
    image.save(r'C:\Users\kiv\Downloads\AstroX\meta_yolo_4/meta_' + str(name) + '_acc_'+ str(round(accuracy,2)) + "_lim_" + str(limiter) + '.bmp')
    print(skipped)
...
scale_show = 100
file_name = "corrected_img_17_1.jpg"
